class OrderAddress
  ...
  def save
    ...
    Address.create(postal_code: postal_code, region_id: region_id, city: city, block_num: block_num, building_name: building_name, phone_num: phone_num, order_id: order.id)
  end
 end